...
namespace CgwMonitorManage.Common
{
    public class CgwConst
    {
        ...
        public static string CGW_CONFIG_FILE_NAME = AppDomain.CurrentDomain.BaseDirectory + "/CgwMonitorManageConfig.xml";
        ...
        /// 刷新设备获取锁等待时间
        /// </summary>
        public const int EFRESH_MONITOR_CAMERA_WAIT_TIME = 0;
        ...
        /// <summary>
        /// 配置文件中的refreshDeviceListOverTime标记
        /// </summary>
        public const string REFRSHDEVICELIST_OVERTIME_TAG = "refreshDeviceListOverTime";

        /// <summary>
        /// 配置文件中的deviceListUnusedOverTime标记
        /// </summary>
        public const string DEVICELISTUNUSED_OVERTIME_TAG = "deviceListUnusedOverTime";
        ...
        /// <summary>
        /// 监控配置文件中T28181平台中ip的标记
        /// </summary>
        public const string SERVERIP_TAG = "serverIp";
        ...
        public const string PASSWORD_TAG = "connPwd";
        ...
        /// T28181 SIP_PORT
        /// </summary>
        public const string SIP_PORT = "serverSipPort";

        /// <summary>
        /// ELTE LOCAL_PORT
        /// </summary>
        public const string LOCAL_ELTE_PORT = "LocalPort";

        /// <summary>
        /// T28181 LOCAL_PORT
        /// </summary>
        public const string LOCAL_PORT = "localSipPort";

        /// <summary>
        /// T28181 localSignalGateway
        /// </summary>
        public const string LOCAL_SIGNAL_GATEWAY = "localSignalGateway";

        /// <summary>
        /// T28181 serverSignalGateway
        /// </summary>
        public const string SERVER_SIGNAL_GATEWAY = "serverSignalGateway";

        /// <summary>
        /// T28181 serverSipAccount
        /// </summary>
        public const string SERVER_SIP_ACCOUNT = "serverSipAccount";

        /// <summary>
        /// T28181 serverSipPasswd
        /// </summary>
        public const string SERVER_SIP_PASSWD = "serverSipPasswd";
        ...
        /// <summary>
        /// 如果艘次加载监控平台失败，会尝试等待一段时间后重新加载，时间定为1分钟（60*1000）
        /// </summary>
        public const int RELOAD_MONITOR_WAIT_TIME = 60000;
