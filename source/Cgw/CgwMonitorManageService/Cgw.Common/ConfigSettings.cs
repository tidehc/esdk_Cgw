...
namespace CgwMonitorManage.Common
{
    public class ConfigSettings
    {
        ...
        /// session超时时间
        /// </summary>
        public static string RefrshDeviceListOverTime
        {
            get
            {
                return GetValueByKey(CgwConst.REFRSHDEVICELIST_OVERTIME_TAG);
            }
            set
            {
                SetValueByKey(CgwConst.REFRSHDEVICELIST_OVERTIME_TAG, value);
            }
        }
        #endregion
        ...
        /// session超时时间
        /// </summary>
        public static string DeviceListUnusedOverTime
        {
            get
            {
                return GetValueByKey(CgwConst.DEVICELISTUNUSED_OVERTIME_TAG);
            }
            set
            {
                SetValueByKey(CgwConst.DEVICELISTUNUSED_OVERTIME_TAG, value);
            }
        }
        #endregion
        ...
        private static string Encrypt(string needEncryptTerm,string nodeEntropy)
        {
            ...
            try
            {
                ...
                //byte[] encryptArray = ProtectedData.Protect(toEncryptArray, null, DataProtectionScope.LocalMachine);
        ...
        private static string Decrypt(string needDecryptTerm,string nodeEntropy)
        {
            ...
            try
            {
                ...
                //byte[] DecryptArray = ProtectedData.Unprotect(toDecryptArray, null, DataProtectionScope.LocalMachine);
